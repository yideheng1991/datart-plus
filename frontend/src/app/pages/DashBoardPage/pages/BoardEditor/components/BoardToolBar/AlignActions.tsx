      ...
      const updates = rects.map(r => {
        ...
        switch (type) {
          ...
          case 'hDistribute': {
            ...
            const gap =
              (totalWidth - totalWidgetWidth) / (rects.length - 1);
          ...
          case 'vDistribute': {
            ...
            const gap =
              (totalHeight - totalWidgetHeight) / (rects.length - 1);
...
const HDistributeIcon = () => (
  <svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false">
    ...
    <rect x="1" y="2" width="3" height="12" fill="none" stroke="currentColor" strokeWidth="0.5" />
    <rect x="6.5" y="2" width="3" height="12" fill="none" stroke="currentColor" strokeWidth="0.5" />
    <rect x="12" y="2" width="3" height="12" fill="none" stroke="currentColor" strokeWidth="0.5" />
  </svg>
);
...
const VDistributeIcon = () => (
  <svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false">
    ...
    <rect x="2" y="1" width="12" height="3" fill="none" stroke="currentColor" strokeWidth="0.5" />
    <rect x="2" y="6.5" width="12" height="3" fill="none" stroke="currentColor" strokeWidth="0.5" />
    <rect x="2" y="12" width="12" height="3" fill="none" stroke="currentColor" strokeWidth="0.5" />
  </svg>
);
